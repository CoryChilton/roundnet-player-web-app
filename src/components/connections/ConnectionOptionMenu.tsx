  ...
  return (
    <div className="flex flex-col items-center text-lg text-gray-300">
      ...
      <div className="mt-4 flex items-start relative text-gray-200 text-xl font-light">
        <button className={`z-10 w-28 hover:text-white duration-150 ${connectionType === 'teammates' && 'text-shadow-glow shadow-purple-300'}`} onClick={changeConnectionType}>Teammates</button>
        <button className={`z-10 w-28 hover:text-white duration-150 ${connectionType === 'both' && 'text-shadow-glow shadow-yellow-300'}`} onClick={changeConnectionType}>Both</button>
        <button className={`z-10 w-28 hover:text-white duration-150 ${connectionType === 'opponents' && 'text-shadow-glow shadow-pink-300'}`} onClick={changeConnectionType}>Opponents</button>
