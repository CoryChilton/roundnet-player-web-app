...
export default function TournamentsPage() {
  ...
  return (
    ...
    <div className="flex flex-col items-center">
      ...
      <p className="text-lg mb-4 text-gray-300 text-center px-4 max-w-3xl">
      ...
      <div className="flex flex-col gap-px">
        {tournaments.map(tournament => 
          <Link key={tournament.tournament_name} href={tournament.url}target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-100 hover:scale-105 duration-100 ease-out flex flex-row justify-between gap-x-4 md:gap-x-8">
              <div>
